package earth.terrarium.crittersandcompanions.client.renderer;
...
public class BubbleLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    private final BubbleModel<AbstractClientPlayer> bubbleModel;

    public BubbleLayer(RenderLayerParent<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> parent, EntityModelSet modelSet) {
        super(parent);
