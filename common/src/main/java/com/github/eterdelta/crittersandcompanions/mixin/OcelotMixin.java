...
public class OcelotMixin {
    ...
    @Redirect(at = @At(value = "FIELD", target = "net/minecraft/world/entity/animal/Ocelot.TEMPT_INGREDIENT:Lnet/minecraft/world/item/crafting/Ingredient;", opcode = 178 /* Opcodes.GETSTATIC */), method = {"registerGoals()V", "isFood(Lnet/minecraft/world/item/ItemStack;)Z"})
