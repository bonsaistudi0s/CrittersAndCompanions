...
public class RollypollyEntity extends TamableAnimal implements GeoEntity {
    ...
    private static final TagKey<Item> TAME_TAG = TagKey.create(Registries.ITEM, CrittersAndCompanions.createId("rolly_polly_tempt_items"));
    private static final TagKey<Item> FOODS_TAG = TagKey.create(Registries.ITEM, CrittersAndCompanions.createId("rolly_polly_food"));
