package io.github.bonsaistudi0s.crittersandcompanions.common.menu;
...
public class RolyPolyMenu extends AbstractContainerMenu {
    ...
    public RolyPolyMenu(int syncId, Inventory playerInventory) {
        this(syncId, playerInventory, new SimpleContainer(SLOTS), null);
    }
