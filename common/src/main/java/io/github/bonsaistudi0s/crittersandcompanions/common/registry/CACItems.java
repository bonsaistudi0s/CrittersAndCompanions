...
public class CACItems {
    ...
    public static final RegistrySupplier<Item> GRAPPLING_HOOK = ITEMS.register("grappling_hook", () -> new GrapplingHookItem(baseProperties().stacksTo(1)));
    ...
    public static final RegistrySupplier<Item> ACORN_HAT = ITEMS.register("acorn_hat", () -> new AcornHatItem(baseProperties().durability(55)));
