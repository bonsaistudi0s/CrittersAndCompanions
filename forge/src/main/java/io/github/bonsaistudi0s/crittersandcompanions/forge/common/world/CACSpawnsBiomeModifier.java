package io.github.bonsaistudi0s.crittersandcompanions.forge.common.world;
...
public class CACSpawnsBiomeModifier implements BiomeModifier {
    ...
    public static final Codec<CACSpawnsBiomeModifier> CODEC = Codec.unit(new CACSpawnsBiomeModifier());
