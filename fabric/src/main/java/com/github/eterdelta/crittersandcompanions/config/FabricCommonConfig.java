...
public class FabricCommonConfig extends CACCommonConfig {
    ...
    private void registerSpawns(ForgeConfigSpec.Builder builder, ResourceKey<? extends EntityType<?>> key, CACWorldGen.SpawnValues defaultValues) {
        ...
        spawnValues.put(key, () -> new CACWorldGen.SpawnValues(weight.get(), min.get(), max.get()));
